...
class ProductController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('Phones4MooStoreBundle:Product')->findAll();
     ...
     * @Method("POST")
     * @Template("Phones4MooStoreBundle:Product:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("Phones4MooStoreBundle:Product:edit.html.twig")
     */
